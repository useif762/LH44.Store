document.addEventListener('DOMContentLoaded', () => {
    ...
    const getBotResponse = (message) => {
        ...
        if (lowerCaseMessage.includes('أهلاً') || lowerCaseMessage.includes('مرحبا') || lowerCaseMessage.includes('ازيك')) {
            return "أهلاً بك! كيف يمكنني مساعدتك اليوم؟";
        } else if (lowerCaseMessage.includes('منتجات') || lowerCaseMessage.includes('تيشرتات') || lowerCaseMessage.includes('هوديز') || lowerCaseMessage.includes('اكسسوارات')) {
            showPage('products');
            return "بالتأكيد! تفضل، هذه صفحة المنتجات.";
        } else if (lowerCaseMessage.includes('سلة') || lowerCaseMessage.includes('عربة التسوق')) {
            showPage('cart');
            return "تم التوجه إلى عربة التسوق الخاصة بك.";
        } else if (lowerCaseMessage.includes('دفع') || lowerCaseMessage.includes('تأكيد الطلب')) {
            showPage('checkout');
            return "تفضل، يمكنك الآن إتمام عملية الدفع.";
        } else if (lowerCaseMessage.includes('شحن') || lowerCaseMessage.includes('توصيل')) {
            return "نحن نقدم خدمة الدفع عند الاستلام. يستغرق التوصيل عادةً من 3 إلى 5 أيام عمل.";
        } else if (lowerCaseMessage.includes('اتصال') || lowerCaseMessage.includes('تواصل')) {
            return "يمكنك العثور على تفاصيل الاتصال بنا في قسم 'Contact' في الموقع.";
        } else if (lowerCaseMessage.includes('مين انت') || lowerCaseMessage.includes('اعرف عنك')) {
            showPage('about');
            return "أنا مساعدك الشخصي في متجر LH44. يمكنك معرفة المزيد عنا في صفحة 'About Us'.";
        } else {
            return "أعتذر، لم أفهم طلبك. يمكنك تجربة كلمات مثل: 'المنتجات', 'السلة', 'التوصيل' لأقدم لك المساعدة.";
        }
    };
